...
public class CheeseLevel extends BaseScreen {
    ...
    public void create() {
       ...
       // mousey.setSize(75,75);
        ...
        timeLabel.setPosition(500, 440); // sets bottom left (baseline) corner?    uiStage.addActor( timeLabel );

        win = false;
    }
    public void update(float dt) {    // process input
        mousey.velocityX = 0;
        mousey.velocityY = 0;
